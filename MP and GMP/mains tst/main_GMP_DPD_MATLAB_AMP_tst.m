...
while (ll<=iterations_num_GMP)
    ...
    PD_coef_GMP_vec = Update_coef_GMP(y_GMP./avg_gain, x_opt_GMP, PD_coef_GMP_vec, orders, miu_GMP);
    AMP_coef_GMP_vec  = Update_coef_GMP(y_GMP, x_opt_GMP, AMP_coef_GMP_vec, orders, miu_GMP);
