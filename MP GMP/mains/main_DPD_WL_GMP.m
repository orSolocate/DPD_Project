...
%% Model User inputs
miu_GMP = -0.01;
Ma = 8 ; Mb = 2 ; Mc = 2 ;                                 %memory depth for GMP model
Ka = 6 ; Kb = 7 ; Kc = 4 ;                                 %non-linearity deg for GMP
          P = 4 ;  Q = 2 ;                                 %cross-terms for GMP
...
z_new = [zeros(first_n_GMP-1,1);PD_GMP(x.*G*0.88, coef,orders); zeros(orders(8),1)];
